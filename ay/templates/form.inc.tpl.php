<form action="" method="post">
	<div class="columns">
		...
		<?php endif;?>
		<div class="column">
			<?=ay_input('query[request_ids]', 'Request IDs', NULL, array('comment' => 'Request ID or a comma-separated list of request IDs to analyse. Entering two IDs will compare the requests.' /* Three or more will list them.*/))?>
		</div>
	</div>
